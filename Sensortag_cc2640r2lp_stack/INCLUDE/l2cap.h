/******************************************************************************
 ...
 @brief This file contains the Logical Link Control and Adaptation
        ...
        Logical Link Control and Adaptation Layer (L2CAP) protocol provides
        ...
        <BR> <h2>L2CAP
        Services</h2> <p>The
        L2CAP layer provides the following services to upper level protocols
        and applications:</p> <ul <ul <ul <ul <ul <ul <ul <ul <ul <ul <ul <ul
        <ul> <li>Fixed and connection-oriented channels with protocol
        multiplexing capability:</li> <ul <ul <ul <ul <ul <ul <ul <ul <ul <ul
        <ul> <li>Attribute
        Protocol (ATT) channel (0x0004).</li> <li>Signaling channel
        (0x0005).</li> <li>Security
        Management Protocol (SMP) channel (0x0006).</li>
        <li>Connection-oriented channels (0x0040-0x007F).</li> </ul </ul </ul
        </ul> <li>Data transport services allowing upper level protocols and
        applications to transmit and receive upper layer
        Service Data Units (SDUs) up to:</li> <ul <ul <ul <ul <ul <ul <ul <ul
        <ul> <li>23 octets in length over a fixed channel. With
        HCI fragmentation and recombination operation enabled, applications can
        transmit and receive larger
        SDUs.</li> <li>512 octets in length over a connection-oriented channel
        with segmentation and reassembly operation.</li operation.</li
        operation.</li> </ul </ul </ul </ul </ul </ul </ul </ul </ul </ul </ul
...
/**
 * L2CAP_NUM_CTRL_DATA_PKT_EVT message format.  This message is sent to the
 ...
 *          bleNotConnected: Connection is down.<BR>
 *          bleNoResources: No available resource.<BR>
 *          bleInvalidRange: a parameter is out or range.<BR>
 */
