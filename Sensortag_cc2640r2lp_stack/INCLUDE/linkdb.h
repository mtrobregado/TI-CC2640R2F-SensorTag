 ...
 */
  ...
  /*
   * linkDB_GetInfo - Copies link information for the given connection handle
   * 
   */
  ...
  /*
   * linkDB_SecurityModeSCOnly - Set a device into Secure Connection Only Mode.
   *                             state is set to TRUE for Secure Connections Only Mode.
   *                             state is set to FALSE to disable Secure Connections Only Mode.
   */ 
